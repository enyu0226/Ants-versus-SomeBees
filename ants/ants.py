...
class Place(object):
    ...
    def __init__(self, name, exit=None):
        ...
        # BEGIN Problem 2
        "*** YOUR CODE HERE ***"
        if self.exit != None: #since exit may be none, check to see if there is exit
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                assert self.ant.can_contain(insect) or insect.can_contain(self.ant),\
                     'Two ants that cannot contain each other in {0}'.format(self)             
                self.ant.place = self
                # If the ant currently occupying a Place can contain the insect (an Ant) passed to add_insect, then it does.
                if self.ant.can_contain(insect):
                	# The contain_ant method takes an Ant argument and sets the bodyguard's ant instance attribute
                    self.ant.contain_ant(insect)
                else:    
                	# set the Place's ant to be the container insect
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # ant  = self.place.ant
        # if ant is None:
        #     return False // bee can advance
        # elif ant and ant.blocks_path is False:
        #     return False // bee can advance
        # return True
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        ...
        # if self.container==True and self.ant==None and other.ant==False
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        #The negation operator in Python is not. Therefore just replace ! with not
        if (not insect.watersafe):
        #if insect.watersafe == False:
             #insect.reduce_armor(99)
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        bees = place.bees[:] # a shallow copy of the whole bee array 
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        ...
        for bee in bees[:]: 
        # bees[:] is a copy of the whole bee array
            bee.reduce_armor(self.damage)
        # END Problem 8
...
class BodyguardAnt(Ant):
    ...
    def contain_ant(self, ant):
        # BEGIN Problem 11
        "*** YOUR CODE HERE ***"
        # takes an Ant argument and sets the bodyguard's ant instance attribute
        self.ant = ant
        # END Problem 11
